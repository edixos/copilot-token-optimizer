...
#   CPTO_MAX_INJECT_FILES — max files to inject per prompt (default: 3)
#   CPTO_MAX_INJECT_WORDS — max total words to inject (default: 1500, ~2000 tokens)

LEARNINGS_DIR="${CPTO_LEARNINGS_DIR:-docs/learnings}"
MAX_FILES="${CPTO_MAX_INJECT_FILES:-3}"
MAX_WORDS="${CPTO_MAX_INJECT_WORDS:-1500}"
...
# Stderr notice (user sees this, not Copilot)
import sys as _sys
for fname, path, content, wcount in injected:
